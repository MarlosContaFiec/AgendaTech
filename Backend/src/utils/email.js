  ...
  return `
    <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px;">
      ...
      <table style="width:100%;border-collapse:collapse;margin:15px 0;">
        <tr><td style="padding:8px;border-bottom:1px solid #eee;color:#666;">Serviço:</td><td style="padding:8px;border-bottom:1px solid #eee;"><strong>${e(servico)}</strong></td></tr>
        <tr><td style="padding:8px;border-bottom:1px solid #eee;color:#666;">Data:</td><td style="padding:8px;border-bottom:1px solid #eee;"><strong>${e(data)}</strong></td></tr>
        <tr><td style="padding:8px;border-bottom:1px solid #eee;color:#666;">Horário:</td><td style="padding:8px;border-bottom:1px solid #eee;"><strong>${e(hora)}</strong></td></tr>
        <tr><td style="padding:8px;border-bottom:1px solid #eee;color:#666;">Local:</td><td style="padding:8px;border-bottom:1px solid #eee;"><strong>${e(empresa)}</strong></td></tr>
      </table>
  ...
  return `
    <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px;">
      ...
      <table style="width:100%;border-collapse:collapse;margin:15px 0;">
        <tr><td style="padding:8px;border-bottom:1px solid #eee;color:#666;">Serviço:</td><td style="padding:8px;border-bottom:1px solid #eee;"><strong>${e(servico)}</strong></td></tr>
        <tr><td style="padding:8px;border-bottom:1px solid #eee;color:#666;">Data:</td><td style="padding:8px;border-bottom:1px solid #eee;"><strong>${e(data)}</strong></td></tr>
        ${motivo ? `<tr><td style="padding:8px;border-bottom:1px solid #eee;color:#666;">Motivo:</td><td style="padding:8px;border-bottom:1px solid #eee;">${e(motivo)}</td></tr>` : ''}
      </table>
    </div>
  `;
}
  ...
  return `
    <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px;">
      ...
      <div style="text-align:center;margin:25px 0;">
        <a href="${e(link)}" style="background:#1a1a2e;color:#fff;padding:14px 32px;text-decoration:none;border-radius:6px;font-weight:bold;display:inline-block;">
          Confirmar Email
        </a>
      </div>
